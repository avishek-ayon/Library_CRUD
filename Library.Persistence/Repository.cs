...
namespace Library.Persistence
{
        ...
        where TEntity : class, IEntity<TKey>
    {
        ...
        public virtual async Task<IList<TEntity>> GetDynamicAsync(Expression<Func<TEntity,
        ...
        public virtual IList<TEntity> Get(Expression<Func<TEntity,
            bool>> filter,
            Func<IQueryable<TEntity>, IIncludableQueryable<TEntity, object>> include = null)
        {
            IQueryable<TEntity> query = _dbSet;
        ...
        protected virtual async Task<TReturn> ExecuteScalerAsync<TReturn>(string storedProcedureName,
        ...
        private async Task<IList<TReturn>> ExecuteQueryAsync<TReturn>(DbCommand command)
        {
            ...
            while (await reader.ReadAsync())
            {
                ...
                if (constructor == null)
                {
                    throw new InvalidOperationException("An empty constructor is required for the return type");
                }
